		 ...
		 for (var r = 0; r < rows; r++)
		   {
			...
			var marginHeight = cellHeight/rows;
 				...
 				{
 					for (var c =0; c< cols; c++) { 						
 						var cell = $("<img class='dulce' id='jewel_"+r+"_"+c+"' r='"+r+"' c='"+c+"' ondrop='_onDrop(event)' ondragover='_onDragOverEnabled(event)'  src='"+grid[r][c].src+"' style='position:fixed;padding-right:20px;top:"+r*cellHeight+"px;left:"+(c*cellWidth+marginWidth)+"px; margin-top: 130px; margin-left: 80px;'/>");
